...
final class InstanceAccessControlTest extends AccessControlTestBase {
   ...
   */
  #[DataProvider('accessInstanceProvider')]
  public function testInstanceAccess(array $data, array $expect): void {
    ...
    // Create the instance with profile id.
    $instance = $this->createDisplayBuilderInstance($data['instance_use_profile_id'] ?? NULL, 'test_instance');
  ...
  /**
   * Data provider for testInstanceAccess().
   *
   * Each case can have:
   ...
   */
  public static function accessInstanceProvider(): array {
    return [
      ...
      'user with same profile as instance' => [
        'data' => [
