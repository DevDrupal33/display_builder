 ...
 *
 * Provides common rendering methods for panel plugins that need to
 * render components and blocks hierarchically (Layers, Tree panels).
 */
abstract class BuilderPanelBase extends IslandPluginBase {
  ...
  public function build(InstanceInterface $builder, array $data = [], array $options = []): array {
    ...
    return $this->htmxEvents->onRootDrop($dropzone, $builder_id, $this->getPluginID());
  }
   ...
   */
  protected function buildComponentSlot(string $builder_id, string $slot_id, array $definition, array $data, string $instance_id): array {
    $dropzone = [
      '#type' => 'component',
      '#component' => 'display_builder:dropzone',
      '#props' => [
