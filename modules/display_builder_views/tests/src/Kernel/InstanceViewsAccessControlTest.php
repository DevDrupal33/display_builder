...
final class InstanceViewsAccessControlTest extends AccessControlTestBase {
   ...
   * {@inheritdoc}
   */
  public string $adminPermission = 'administer views';
  ...
  protected static $modules = [
    ...
    // Required for administer views permission.
    'views',
    // Required for administer views permission.
    'views_ui',
  ];
   ...
   */
  #[DataProvider('accessInstanceViewsProvider')]
  public function testInstanceViewsAccess(array $data, array $expect): void {
    ...
    $instance = $this->createDisplayBuilderInstance($data['instance_use_profile_id'] ?? NULL, self::PREFIX . 'test__test');
  ...
  /**
   * Data provider for testInstanceViewsAccess().
   *
   * Each case needs:
   ...
   */
  public static function accessInstanceViewsProvider(): array {
    return [
