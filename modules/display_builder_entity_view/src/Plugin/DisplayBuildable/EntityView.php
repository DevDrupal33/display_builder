...
final class EntityView extends DisplayBuildablePluginBase {
  ...
  public function getProfile(): ?ProfileInterface {
    $display_builder_id = $this->entity->getThirdPartySetting('display_builder', ConfigFormBuilderInterface::PROFILE_PROPERTY);
  ...
  public function getSources(): array {
    return $this->entity->getThirdPartySetting('display_builder', ConfigFormBuilderInterface::SOURCES_PROPERTY, []);
  }
  ...
  public function saveSources(): void {
    ...
    $this->entity->setThirdPartySetting('display_builder', ConfigFormBuilderInterface::SOURCES_PROPERTY, $data);
    $this->entity->save();
  }
